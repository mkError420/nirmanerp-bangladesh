...
export const DashboardOverview: React.FC<DashboardOverviewProps> = ({
  ...
  const allModules = [
    ...
    { id: 'units', category: 'CIVIL', label: 'Unit Inventory Matrix', icon: Building2, desc: 'Real estate apartment inventory & booking statuses' },
    ...
    { id: 'salary-disbursal', category: 'HR', label: 'BEFTN & MFS Disbursal', icon: DollarSign, desc: 'Bangladesh Bank BEFTN batch files & bKash payouts' },
    ...
    { id: 'tax-ait', category: 'FINANCE', label: 'NBR Tax & AIT Compliance', icon: FileCheck2, desc: 'NBR Income Tax Act 2023 5% AIT & TDS compliance' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 via-[#0b162c] to-blue-950 p-6 lg:p-7 text-white shadow-lg border border-slate-800">
        <div className="absolute right-0 top-0 -mt-8 -mr-8 w-96 h-96 rounded-full bg-blue-500/10 blur-3xl pointer-events-none" />
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              ...
              {pendingApprovalsCount > 0 && (
                <span className="w-5 h-5 rounded-full bg-white text-blue-700 text-[10px] font-bold flex items-center justify-center">
                  {pendingApprovalsCount}
                </span>
              )}
            </button>
            ...
            >
              ...
              <span className="hidden sm:inline">DPR</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="mt-3 text-xs text-slate-500 border-t border-slate-100 pt-2.5 flex items-center justify-between">
            ...
            <span className="text-blue-600 font-semibold text-xs flex items-center gap-1 group-hover:translate-x-0.5 transition">
        ...
        >
          ...
          <div className="mt-3 text-xs text-slate-500 border-t border-slate-100 pt-2.5 flex items-center justify-between">
            ...
            <span className="text-purple-600 font-semibold text-xs flex items-center gap-1 group-hover:translate-x-0.5 transition">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left: Department Workflow Chain & Recent Handoffs */}
          ...
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Strict sequential handoff: Purchase → Store → Costing → Project → Accounts</p>
              </div>
            </div>
        ...
        {/* Right: Subcontractor Ledger & Tax Deductions Summary */}
      ...
      {/* Modern Enterprise Modules Launchpad */}
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="w-8 h-8 rounded-xl bg-slate-100 group-hover:bg-blue-50 text-slate-700 group-hover:text-blue-600 flex items-center justify-center transition">
